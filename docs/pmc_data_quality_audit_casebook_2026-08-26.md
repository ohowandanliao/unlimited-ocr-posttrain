...
| split | JSONL 绝对路径 | 行数 | SHA-256 |
|---|---|---:|---|
| train | `/Users/guofengjiao/Documents/uocr_readoc_pmc_silver_mix_v1/train.jsonl` | 4073 | `38491b6e5ebb5fa416363e25e536a09a8522d632089c7dc8c9fe9cebc6e4a74e` |
| validation | `/Users/guofengjiao/Documents/uocr_readoc_pmc_silver_mix_v1/validation.jsonl` | 223 | `e8d738de4a90dedebe9dff53b808ee56ddd3b02fc65f5213cd3ffb02e4c2ccde` |
| test | `/Users/guofengjiao/Documents/uocr_readoc_pmc_silver_mix_v1/test.jsonl` | 228 | `26957bbb3090829c519c1fc4081cb12d42d16149b74b7faf4c2cece9cb39b201` |

middle 根目录：`/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/<doc_id>/middle.json`。
...
- **middle 定位**：`/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/pmc13425563/middle.json`，SHA-256 `37eff540f43facda700b9d5c0308414f0e6915d1e5e3afd8de7a3921c0a13722`，page `0`，pointer `/pdf_info/0/para_blocks/0/lines/0/spans/0/content`，`middle_json_snippet`：`Research ArticleApplications of Polymer, Composite, and Coating Materials`。
...
- **middle 定位**：`/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/pmc13215880/middle.json`，SHA-256 `dd5a133ea62c21f8c48f671cb3267a48e2342ca0f58128b33e76eb8bbad42821`，page `6`，pointer `/pdf_info/6/para_blocks/9/lines/0/spans/0/content`，`middle_json_snippet`：`v( R) = \sqr t{\fra c{GM( \;<R) }{R}}`。
...
- **middle 定位**：`/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/pmc13424892/middle.json`，SHA-256 `1e1e94cd0bf9ce413a82ce705f28432a73e4675c35f80e79bc1b98537a52fbb6`，page `0`，pointer `/pdf_info/0/para_blocks/0/lines/0/spans/0/content`，`middle_json_snippet`：同样片段。
...
- **middle 定位**：`/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/pmc13252203/middle.json`，SHA-256 `3a7868992e005664ec879c54102a8a3b3cd4c68e630ecd180e15337c6f2d494f`；page `17`、`18`、`19` 的 pointers `/pdf_info/17/para_blocks`、`/pdf_info/18/para_blocks`、`/pdf_info/19/para_blocks` 均为 `[]`，`preproc_blocks` 也均为 `[]`；`middle_json_snippet`：`page_idx=17/18/19: para_blocks=[]`。
...
- **middle 定位**：`/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/pmc13435129/middle.json`，SHA-256 `da3f5f4d43a96b45982e2f4a0ac8fd43641051d9a9ea96e902a52fc66cb692b2`，page `33`，pointer `/pdf_info/33/para_blocks/9/blocks/0/lines/0/spans/0/image_path`，`middle_json_snippet`：`nihms-2195067-f0001.jpg`。
- **raw→JSONL**：`meta.doc_id=pmc13435129` 与 middle SHA 匹配；renderer 将 raw `image_path` 序列化成 Markdown 图片链接。绝对候选路径 `/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/pmc13435129/nihms-2195067-f0001.jpg` 不存在。
...
- **middle 定位**：`/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/pmc10933458/middle.json`，SHA-256 `67261e77ed16e3715e22848b1a5fa9030b3ba1446deff83378189c9422b63963`，第 21 页（`page_idx=20`），pointer `/pdf_info/20/para_blocks/2/blocks/0/lines/0/spans/0/html`，`middle_json_snippet=<table-wrap id="Tab1">...<img src="44319_2024_77_Tab1_HTML.jpg">...</table-wrap>`；相邻 `image_path=assets/table_p20_o2_table.png`，无 HTML `<table>`。
...
- **middle 定位**：`/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/pmc13424892/middle.json`，SHA-256 `1e1e94cd0bf9ce413a82ce705f28432a73e4675c35f80e79bc1b98537a52fbb6`，page `0`，pointer `/pdf_info/0/para_blocks/0/lines/0/spans/0/content`，`middle_json_snippet`：`Systematic ReviewAcademicSubjects/MED00010AcademicSubjects/MED00160AcademicSubjects/MED00240`。
...
- **middle 定位**：`/Users/guofengjiao/Documents/pmc_v26_pdf_gt_20260816/documents/pmc13426939/middle.json`，SHA-256 `7fa1a6876a2122152453d79fa5bec36e49070e9ccfdf59c7ebcbf926aa99194f`，page `25`，pointer `/pdf_info/25/para_blocks/3/lines/0/spans/0/content`，`middle_json_snippet`：`-->PONE-D-25-58370-->-->Microbial communities in`。
