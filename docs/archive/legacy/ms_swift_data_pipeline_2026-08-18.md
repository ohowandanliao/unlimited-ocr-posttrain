...
> **历史资料：不可作为当前执行入口。** 本文保留数据管线研究；其中旧的 silver、S10/S20、title-weighted 和 full-parameter 方案均不可直接执行。当前训练、数据混合及 PMC/标题结论以 [`training_optimization_2026-08-26.md`](../../training_optimization_2026-08-26.md) 为准。
